...
def main() -> int:
    ...
    p.add_argument("--us-csv", default="data/US_Stocks.csv", help="Path to US_Stocks.csv")
    p.add_argument("--global-csv", default="data/Global_Stocks.csv", help="Path to Global_Stocks.csv")
    p.add_argument("--out-csv", default="data/All_Stocks.csv", help="Output combined CSV")
    p.add_argument("--out-db", default="data/All_Stocks.sqlite", help="Output combined SQLite DB")
    p.add_argument("--out-txt", default="data/All_Tickers.txt", help="Output combined tickers text")
    args = p.parse_args()
